...
find /data/web/ -name "Apis.php" -print0 | xargs -0 perl -pi -e 's|http://sourceHostIP/|http://targetHostIP/|g'
...
find /etc/nginx/conf.d/ -name "*.conf" -print0 | xargs -0 perl -pi -e "s|http://sourceProxyIP|http://targetProxyIP|g"
